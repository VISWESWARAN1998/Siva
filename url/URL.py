...
class URL:
    ...
    def post_request(self, url, data, user_agent=None):
        ...
        try:
            ...
            self.post_request(url=url, user_agent=user_agent, data=data)
        except requests.exceptions.MissingSchema:
            return None
        except requests.exceptions.InvalidURL:
            return None
    ...
    def get_head_request(self, url, user_agent=None):
        """
        Description:
        ============
        This method is used to get only the head request to the respective url
        Special Thanks To:
        ==================
        Mohan Ravichandran for tipping this information
        Parameters:
        ===========
        :param url: The url for which the requests object is to be returned
        :param user_agent: The user_agent to be used
        ...
        try:
            ...
            self.get_head_request(url=url, user_agent=user_agent)
        except requests.exceptions.MissingSchema:
            return None
        except requests.exceptions.InvalidURL:
            return None
