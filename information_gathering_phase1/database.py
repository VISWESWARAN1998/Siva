...
class InfoGatheringPhaseOneDatabase:
    ...
    @staticmethod
    def add_info_gathering_phase_one(database_semaphore, connection, query,
                                     arguments):
        """
        ...
        try:
            ...
            )  # No matter what happens release the semaphore
    ...
    @staticmethod
    def update_webserver_name(database_semaphore, connection, project_id,
                              new_webserver_name):
        """
        Used to update the ip address in the info gathering database
        :param database_semaphore:
    ...
    @staticmethod
    def update_server_os(database_semaphore, connection, project_id,
                         server_os):
        """
        Used to update the ip address in the info gathering database
        :param database_semaphore:
    ...
    @staticmethod
    def update_programming_language(database_semaphore, connection, project_id,
    ...
    @staticmethod
    def update_firewall(database_semaphore, connection, project_id,
                        firewall_name):
        """
        Used to update the ip address in the info gathering database
        :param database_semaphore:
